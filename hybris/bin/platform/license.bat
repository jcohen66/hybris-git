...
SET LOG_4J_LIB=%CORE_LIB%/log4j-1.2.17.jar;%CORE_LIB%/slf4j-api-1.7.21.jar;%CORE_LIB%/log4j-api-2.7.jar;%CORE_LIB%/log4j-core-2.7.jar;%CORE_LIB%/log4j-slf4j-impl-2.7.jar
SET GUAVA_LIB=%CORE_LIB%/guava-21.0.jar
SET SPRING_LIB=%CORE_LIB%/spring-core-4.3.3.RELEASE.jar;%CORE_LIB%/spring-context-4.3.3.RELEASE.jar;%CORE_LIB%/spring-beans-4.3.3.RELEASE.jar
