...
(function() {
    ...
    .factory('ClonePageBuilderFactory', function($q, lodash, contextAwarePageStructureService, componentHandlerService, typeStructureRestService, cmsitemsRestService, catalogService) {
     ...
     */
    .controller('clonePageWizardController', function($q, GENERIC_EDITOR_UNRELATED_VALIDATION_MESSAGES_EVENT, lodash, wizardManager, ClonePageBuilderFactory, restrictionsStepHandlerFactory,
