...
describe('displayConditionsEditorController', function() {
    ...
    beforeEach(function() {
        var harness = AngularUnitTestHelper.prepareModule('displayConditionsEditorControllerModule')
    ...
    beforeEach(function() {
        controller.pageUid = 'somePageUid';
    });
    ...
    it('onPrimaryPageSelect will delegate to the model to set the new primary page', function() {
        ...
        expect(mocks.displayConditionsEditorModel.setAssociatedPrimaryPage).toHaveBeenCalledWith({
            label: 'some-primary-page-label',
            name: 'Some Primary Page',
            uid: 'somePrimaryPage'
        });
