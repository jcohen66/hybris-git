...
describe("GenericEditor Media Upload", function() {
    ...
    it('GIVEN a Media structure type is present in the Generic Editor ' +
        ...
        function() {
            selectFileToUpload('invalid.doc').then(function() {
                ...
                expect(element(by.css(getCssForEnglish('se-media-upload-form'))).isPresent()).toBe(false);
    ...
    it('GIVEN a Media structure type is present in the generic editor ' +
        ...
        function() {
            selectFileToUpload('more_bckg.png').then(function() {
                ...
                expect(element(by.css(getCssForEnglish("se-media-selector"))).isPresent()).toBe(false);
                expect(element(by.cssContainingText(getCssForEnglish("se-file-selector"), 'se.upload.image.to.library')).isPresent()).toBe(false);
                expect(element(by.css(getCssForEnglish('se-media-upload-form'))).isPresent()).toBe(true);
                expect(element(by.css(getCssForEnglish('se-errors-list'))).isPresent()).toBe(false);
    ...
    it('GIVEN a media is selected ' +
        ...
        function() {
            element(by.css(getCssForEnglish('.media-advanced-information'))).click();
