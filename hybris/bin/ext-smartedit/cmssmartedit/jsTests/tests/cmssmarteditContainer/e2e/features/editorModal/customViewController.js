...
angular.module('customViewModule', ['templateCacheDecoratorModule', 'ngMockE2E', 'coretemplates', 'editorModalServiceModule', 'sharedDataServiceModule', 'renderServiceModule', 'genericEditorModule', 'eventServiceModule', 'resourceLocationsModule'])
    .constant('PATH_TO_CUSTOM_VIEW', 'editorModal/customView.html')
    .controller('customViewController', function(editorModalService, sharedDataService, restServiceFactory, $window, $httpBackend, $q, $log, ITEMS_RESOURCE_URI) {
