 ...
 */
/* jshint unused:false, undef:false, undef:false */ // ===================== CONF =====================
//
...
var sfBuilder = function() {
     ...
     * various types of storefront and front end technologies/stacks.
     *
    ...
    function StorefrontBuilder() {
        ...
        this.build = function(conf) {
            ...
            conf = conf || {};
            conf = sfConfigManager.getConfig(conf.layoutAlias, conf.delayAlias, conf.renderAlias);
         ...
         * @param parentComponentIds
         */
        this.addNodeToTree = function(alias, parentComponentIds) {
        ...
        this.queueAddComponent = function(alias, parentComponentIds) {
            queuedOperations.push(function() {
                return this.addNodeToTree(alias, parentComponentIds);
            }.bind(this));
        }.bind(this);
        ...
        function getTemplateUrl(node) {
            ...
            return base + node.nodeType + '/' + node.componentId + '.html';
        }
