...
var sfConfigManager = function() {
    ...
    function ConfigManager() {
        ...
        this.getConfig = function(layoutAlias, delaysAlias, rendererAlias) {
            layoutAlias = layoutAlias || this.ALIASES.DEFAULT_LAYOUT_ALIAS;
            delaysAlias = delaysAlias || this.ALIASES.DEFAULT_DELAY_ALIAS;
            rendererAlias = rendererAlias || this.ALIASES.JS_RENDERED_ALIAS;
            var conf = {
                tree: this.getLayout(layoutAlias),
                delay: this.getDelayStrategy(delaysAlias),
                renderer: this.getRenderStrategy(rendererAlias)
            };
