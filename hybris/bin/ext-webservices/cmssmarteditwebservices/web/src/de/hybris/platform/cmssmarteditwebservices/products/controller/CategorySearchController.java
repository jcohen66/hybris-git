...
public class CategorySearchController
{
	...
	@ResponseBody
	public CategorySearchResultWsDTO findProductCategoriesByTextOrMask(@RequestParam(required = false) final String text,
			@RequestParam(required = false) final String mask, @ModelAttribute final PageableWsDTO pageableDto)
	{
		...
		final SearchResult<CategoryData> productSearchResult = getCmsSeProductSearchFacade().findProductCategories(searchText,
